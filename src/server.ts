...
import { registerUserSessionTools } from "./tools/users-sessions.js";
...
- query_users / get_user / get_current_user / create_user / update_user / delete_user
- request_password_reset / request_current_password_reset / update_password / update_current_password / reset_user_secret
...
- get_user_sessions / disconnect_user_session
...
Recommended flow: attach asset-model resources or call get_asset_types before creating/updating assets; call query_assets before mutating. For multi-realm work, call list_accessible_realms first.`,
  ...
  registerUserSessionTools(server);
